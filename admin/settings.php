        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
               ...
               <!--- General Settings Section -->
                ...
                <div class="modal fade" id="contact-s" data-bs-backdrop="static" data-bs-keyboard="true">
                        ...
                        <div class="row" id="team-data">
                            <!-- <div class="col-md-2 mb-3">
                                <div class="card bg-dark text-white">
                                    <img src="../images/about/staff.svg" alt="" class="card-img">
        ...
        <script>
            ...
            function get_general(){
                ...
                xhr.onload = function(){
                    ...
                    }else if(general_data.shutdown == 1){
            ...
            function get_contacts(){ 
                ...
                xhr.onload = function(){
                    ...
                    contacts_p_id.forEach((contacts_id, i)=>{
                        document.getElementById(contacts_id).innerText = contacts_data[i+1];
                    }) 
                    
                    iframe.src = contacts_data[9];
                    contacts_inp(contacts_data);
                   
                    document.getElementById("address_inp").innerText = contacts_data[1];
            ...
            function contacts_inp(data){              
                ...
                contacts_inp_id.forEach((contact_inp_id, i)=>{                                   
                    document.getElementById(contact_inp_id).value = data[i+1];                                      
                }) 
