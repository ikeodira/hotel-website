<?php 
  require('admin/incl/db_config.php');
  require('admin/incl/essentials.php');
?>
        ...
        <form>
            ...
            <div class="modal-body">
              <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                Note: Your details must match with your ID. (NIN Card, Passport, Driving License, etc.)
              ...
              <div class="text-center my-1">
                <button type="button" class="btn btn-dark shadow-none">REGISTER</button>
              </div>
